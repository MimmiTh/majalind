			...
			while ($posts->have_posts()) : $posts->the_post(); ?>
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<footer class="entry-meta">
						<?php the_category(', ');?><span class="sep"> - </span><a href="<?php comments_link(); ?>"><?php comments_number( 'Lämna en kommentar', '1 kommentar', '% kommentarer' ); ?></a><span class="sep">  -  </span><?php edit_post_link( __( 'Redigera inlägg', 'maja_lind' ), '<span class="edit-link">', '</span>' ); ?>
					</footer><!-- .entry-meta -->
